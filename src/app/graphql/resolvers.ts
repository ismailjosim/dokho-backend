...
export const resolvers = {
  ...
  Query: {
    ...
    workers: (_parent: unknown, args: unknown) =>
      WorkerProfileService.searchWorkers(args),
  ...
  Mutation: {
    createUser: (_parent: unknown, args: { input: unknown }) =>
      UserService.createUser(args.input),
    requestOtp: (_parent: unknown, args: { phone: string }) =>
      AuthService.requestOtp(args),
